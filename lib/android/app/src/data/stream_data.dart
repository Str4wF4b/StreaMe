...
final allStreams = <Stream>[
  ...
  const Stream(
      ...
      seasonOrDuration: "3 Seasons",
      genre: ["Crime", "Drama"],
      cast: ["Evan Peters", "Richard Jenkins", "Molly Ringwald", "Michael Learned"],
      direction: ["Ryan Murphy", "Ian Brennan"],
      plot: "This series examines the gruesome and horrific true crimes of Jeffrey Dahmer and the systemic failures that enabled one of America’s most notorious serial killers to continue his murderous spree in plain sight for over a decade.",
      provider: ["Netflix"],
      image: "https://www.themoviedb.org/t/p/w600_and_h900_bestv2/f2PVrphK0u81ES256lw3oAZuF3x.jpg"
  ),
  const Stream(
      id: 10,
