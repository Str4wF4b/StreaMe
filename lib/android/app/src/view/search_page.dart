...
import 'package:stream_me/android/app/src/model/stream_model.dart';
...
class SearchPage extends StatefulWidget {
  ...
  late List<Stream> streams = allStreams;
...
class _SearchPageState extends State<SearchPage> {
                  ...
                  onTap: () {
                    showDialog(
                        ...
                        builder: (BuildContext context) {
                          return Dialog(
                            backgroundColor:
                                widget.middleBackgroundColor.withOpacity(0.93),
   ...
   */
  Widget buildStream(Stream stream) => ListTile(
